(function($) {
    ...
    $.dropifyGallery = function(el, options) {
        ...
        base.init = function() {
            ...
            base.$el
                .dropify(base.options.dropify)
                .on("dropify.fileReady", function(event, previewable, src) {
                    var img = $("<img>", {
                        src: src
                    });
                    img.resizeImage(
                    ...
                    img.on("change", function(e) {
                        ...
                        if (base.options.gallery) {
                            ...
                            var $toDelete = base.sortable.children().filter(":not(:last)");
